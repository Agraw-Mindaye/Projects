    ...
    while (run) {
        ...
        switch(option) {
            case 1:
                ...
                print_matrix(outfile, "Sum", answer);
                break;
            case 2:
                calc_diff(m1, m2, answer);
                print_matrix(outfile, "Difference", answer);
                break;
            case 3:
                calc_prod(m1, m2, answer);
                print_matrix(outfile, "Product", answer);
                break;
            case 4:
                ...
                print_matrix(outfile, "Scalar Product", answer);
                break;
            case 5:
                cout<<"Which matrix would you like to use (1 or 2): ";
                cin>>option;
                ...
                print_matrix(outfile, "Matrix Inverse", answer);
                break;
            default:
                run = false;
                break;
